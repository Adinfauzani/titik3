...
import { Home, Info, MoreHorizontal, ShoppingCart, Coffee, Music, Handshake } from "lucide-react"
...
export default function CustomerLayout({
  ...
  useEffect(() => {
    const onScroll = () => {
      ...
      if (y > lastScrollY.current && y > 100) {
        ...
        clearTimeout(hideTimer.current)
        hideTimer.current = setTimeout(() => setNavVisible(true), 3000)
      }
  ...
  return (
    <div className="relative min-h-screen">
      ...
      >
        <div className="relative mb-4 flex items-center gap-2 rounded-full border border-dark-600/20 bg-dark-800/90 px-3 py-2.5 shadow-2xl shadow-black/40 backdrop-blur-2xl">
              ...
              return (
                <div key="mores" className="relative">
                  <button
                    ...
                    className="flex items-center justify-center rounded-full p-2.5 text-text-secondary transition-colors hover:bg-dark-700 hover:text-coffee-400"
                  >
                      ...
                      >
                        <div className="flex gap-2">
                          <Link
                            ...
                            className="flex flex-col items-center gap-1 rounded-xl px-4 py-3 text-text-secondary transition-colors hover:bg-dark-700 hover:text-coffee-400"
                          >
                          ...
                          >
                            ...
                            <span className="text-[9px] font-medium">Kolab</span>
                          </Link>
                        </div>
                      </motion.div>
                    )}
