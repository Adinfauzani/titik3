  ...
  return (
    <Section className="py-24 sm:py-32">
      <motion.div
        initial="visible"
        variants={fadeUp}
        className="relative overflow-hidden rounded-2xl border border-dark-600/40 bg-gradient-to-b from-dark-800 to-dark-900 p-12 text-center sm:p-16"
      >
        ...
        <div className="relative">
          ...
          <h2 className="font-cursive text-4xl sm:text-5xl">
            Setiap Cerita Punya
            <br />
