  ...
  return (
    <section className="relative min-h-screen overflow-hidden">
      ...
      <motion.div
        ...
        animate="visible"
        variants={stagger}
        className="relative mx-auto flex min-h-screen max-w-6xl flex-col items-center justify-center px-4 pb-20 pt-6 lg:flex-row lg:gap-20 lg:pt-10"
      >
        <div className="flex-1 text-center lg:text-left">
          <motion.div variants={fadeUp} className="mb-5 flex justify-center gap-2 lg:justify-start">
            {[0, 1, 2].map((i) => (
              <motion.span
                key={i}
                ...
                className="inline-block h-3 w-3 rounded-full bg-coffee-400 shadow-lg shadow-coffee-500/30"
              />
            ))}
          </motion.div>
          ...
          <motion.p
            variants={fadeUp}
            className="mb-3 text-xs font-medium uppercase tracking-[0.3em] text-coffee-400"
          >
            Warkop Titik 3
          </motion.p>
          ...
          <motion.h1
            variants={fadeUp}
            className="font-heading text-4xl font-bold leading-[1.15] tracking-tight sm:text-6xl lg:text-7xl"
          >
            Titik Temu untuk{" "}
          ...
          <motion.p
            variants={fadeUp}
            className="mx-auto mt-5 max-w-md text-sm leading-relaxed text-text-secondary lg:mx-0"
          >
          ...
          <motion.div variants={fadeUp} className="mt-10 flex justify-center gap-5 lg:justify-start">
