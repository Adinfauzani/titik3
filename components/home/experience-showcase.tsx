      ...
      >
        {experiences.map((e) => (
          <motion.div
            ...
            className={`group relative overflow-hidden rounded-2xl border border-dark-600/30 bg-dark-800/30 p-5 transition-all duration-500 hover:-translate-y-0.5 hover:border-coffee-500/20 hover:shadow-xl hover:shadow-coffee-600/5 sm:p-6 ${
              e.span === 3 ? "col-span-3" : e.span === 2 ? "col-span-2" : "col-span-1"
            }`}
          >
            ...
            <div className="relative">
              <div className="mb-4 flex h-11 w-11 items-center justify-center rounded-xl bg-dark-700/70 backdrop-blur-sm transition-colors group-hover:bg-coffee-600/20">
                <e.icon className="h-5 w-5 text-coffee-400" />
              </div>
