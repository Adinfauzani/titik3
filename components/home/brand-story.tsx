...
export function BrandStory() {
  return (
    <Section className="py-24 sm:py-32" id="tentang">
      <div className="mb-14 text-center">
        ...
        <motion.h2
          initial={{ opacity: 1, y: 0 }}
          className="mt-3 font-cursive text-4xl sm:text-5xl"
        >
      ...
      >
        {pillars.map((p) => (
          <motion.div
            ...
            className="group rounded-2xl border border-dark-600/30 bg-dark-800/30 p-6 text-center transition-all duration-500 hover:-translate-y-0.5 hover:border-coffee-500/20 hover:shadow-xl hover:shadow-coffee-600/5 sm:p-8"
          >
            ...
            <h3 className="mb-2 text-lg font-bold text-text-primary sm:text-xl">{p.title}</h3>
